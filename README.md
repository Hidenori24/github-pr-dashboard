...
- **現在の期間**: 今週、先週、今月、先月、過去30日、過去90日から選択
- **過去週単位**: 過去52週間（1年分）の週次データから選択して表示
- **過去月単位**: 過去24ヶ月（2年分）の月次データから選択して表示
- **過去年単位**: 過去3年分の年次データから選択して表示

### 主な統計指標

- **期間サマリー**: 総PR数、マージ率、平均リードタイム、アクティブ開発者数
- **トレンド分析**: 
  - 現在の期間モード: 過去8週間のPR作成数と平均リードタイムの推移
  - 過去週単位: 過去12週間の推移
  - 過去月単位: 過去12ヶ月の推移
  - 過去年単位: 全年の推移
- **レビュー活動**: 総レビュー数、総コメント数、PR当たりの平均値
...
- GitHub Actions実行時に自動的に過去データを保存
- 週次、月次、年次の統計データを自動計算
- 長期的なトレンド分析が可能
